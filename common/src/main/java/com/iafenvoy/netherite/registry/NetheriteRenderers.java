...
public final class NetheriteRenderers {
    ...
    public static void registerModelPredicates() {
        ItemPropertiesRegistry.register(NETHERITE_ELYTRA.get(), Identifier.of("broken"), (itemStack, clientWorld, livingEntity, i) -> ElytraItem.isUsable(itemStack) ? 0.0F : 1.0F);
        ItemPropertiesRegistry.register(NETHERITE_FISHING_ROD.get(), Identifier.of("cast"), (itemStack, clientWorld, livingEntity, i) -> {
        ...
        ItemPropertiesRegistry.register(NETHERITE_BOW.get(), Identifier.of("pull"), (itemStack, clientWorld, livingEntity, i) -> livingEntity == null ? 0.0F : livingEntity.getActiveItem() != itemStack ? 0.0F : (itemStack.getMaxUseTime(livingEntity) - livingEntity.getItemUseTimeLeft()) / 20.0F);
        ItemPropertiesRegistry.register(NETHERITE_BOW.get(), Identifier.of("pulling"), (itemStack, clientWorld, livingEntity, i) -> livingEntity == null ? 0.0F : livingEntity.isUsingItem() && livingEntity.getActiveItem() == itemStack ? 1.0F : 0.0F);
        ItemPropertiesRegistry.register(NETHERITE_CROSSBOW.get(), Identifier.of("pull"), (itemStack, clientWorld, livingEntity, i) -> livingEntity == null ? 0.0F : CrossbowItem.isCharged(itemStack) ? 0.0F : (float) (itemStack.getMaxUseTime(livingEntity) - livingEntity.getItemUseTimeLeft()) / (float) CrossbowItem.getPullTime(itemStack, livingEntity));
        ItemPropertiesRegistry.register(NETHERITE_CROSSBOW.get(), Identifier.of("pulling"), (itemStack, clientWorld, livingEntity, i) -> livingEntity == null ? 0.0F : livingEntity.isUsingItem() && livingEntity.getActiveItem() == itemStack && !CrossbowItem.isCharged(itemStack) ? 1.0F : 0.0F);
        ItemPropertiesRegistry.register(NETHERITE_CROSSBOW.get(), Identifier.of("charged"), (itemStack, clientWorld, livingEntity, i) -> livingEntity == null ? 0.0F : CrossbowItem.isCharged(itemStack) ? 1.0F : 0.0F);
        ItemPropertiesRegistry.register(NETHERITE_CROSSBOW.get(), Identifier.of("firework"), (itemStack, clientWorld, livingEntity, i) -> livingEntity == null ? 0.0F : CrossbowItem.isCharged(itemStack) && itemStack.get(DataComponentTypes.CHARGED_PROJECTILES).contains(Items.FIREWORK_ROCKET) ? 1.0F : 0.0F);
        ItemPropertiesRegistry.register(NETHERITE_TRIDENT.get(), Identifier.of("throwing"), (itemStack, clientWorld, livingEntity, i) -> livingEntity != null && livingEntity.isUsingItem() && livingEntity.getActiveItem() == itemStack ? 1.0F : 0.0F);
    }

...
public final class NetheriteItems {
    ...
    public static final RegistrySupplier<Item> NETHERITE_ELYTRA = register(Identifier.of(NetheriteExtension.MOD_ID, "netherite_elytra"), () -> NetheriteElytraItem.create(new Item.Settings().maxDamage(NetheriteExtensionConfig.INSTANCE.durability.elytra).rarity(Rarity.UNCOMMON).fireproof()));
    public static final RegistrySupplier<Item> NETHERITE_FISHING_ROD = register(Identifier.of(NetheriteExtension.MOD_ID, "netherite_fishing_rod"), () -> new NetheriteFishingRodItem(new Item.Settings().maxDamage(NetheriteExtensionConfig.INSTANCE.durability.fishing_rod).fireproof()));
    public static final RegistrySupplier<Item> NETHERITE_BOW = register(Identifier.of(NetheriteExtension.MOD_ID, "netherite_bow"), () -> new NetheriteBowItem(new Item.Settings().maxDamage(NetheriteExtensionConfig.INSTANCE.durability.bow).fireproof()));
    public static final RegistrySupplier<Item> NETHERITE_CROSSBOW = register(Identifier.of(NetheriteExtension.MOD_ID, "netherite_crossbow"), () -> new CrossbowItem(new Item.Settings().maxDamage(NetheriteExtensionConfig.INSTANCE.durability.crossbow).fireproof()));
    public static final RegistrySupplier<Item> NETHERITE_TRIDENT = register(Identifier.of(NetheriteExtension.MOD_ID, "netherite_trident"), () -> new NetheriteTridentItem(new Item.Settings().maxDamage(NetheriteExtensionConfig.INSTANCE.durability.trident).fireproof()));
    ...
    public static final RegistrySupplier<Item> NETHERITE_HORSE_ARMOR = register(Identifier.of(NetheriteExtension.MOD_ID, "netherite_horse_armor"), () -> new NetheriteHorseArmorItem(new Item.Settings().maxCount(1).fireproof()));
    ...
    public static final RegistrySupplier<Item> NETHERITE_SHEARS = register(Identifier.of(NetheriteExtension.MOD_ID, "netherite_shears"), () -> new ShearsItem(new Item.Settings().fireproof().maxDamage(NetheriteExtensionConfig.INSTANCE.durability.shears)));
    public static final RegistrySupplier<Item> NETHERITE_SHIELD = register(Identifier.of(NetheriteExtension.MOD_ID, "netherite_shield"), () -> NetheriteShieldItem.create(new Item.Settings().fireproof().maxDamage(NetheriteExtensionConfig.INSTANCE.durability.shield)));
